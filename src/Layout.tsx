...
export default ({
  ...
  return (
    <div className="w-full h-full">
      <Link
        to="/"
        className="fixed duration-300 top-6 left-6 p-4 rounded text-gray-800/70 group-hover:text-gray-800 bg-gray-200/70 border-gray-500/70 hover:bg-gray-200 group-hover:border-gray-500 hover:border-gray-500 shadow-[0px_3px_6px_rgba(0,0,0,0.4),0px_8px_13px_-4px_rgba(0,0,0,0.3),0px_-3px_0px_inset_rgba(0,0,0,0.2)]"
      >
        Voltar
      </Link>
